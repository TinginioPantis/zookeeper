...
fun main() {
    do {
        println("Please enter the number of the habitat you would like to view (0-5) or 'exit' for exiting:")
        val input = readLine()!!
        val shouldContinue = input != "exit"
        if (shouldContinue) {
            val selectedAnimalNumber = input.toInt()
            println(animals[selectedAnimalNumber])
        }
